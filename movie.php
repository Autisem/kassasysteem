    ...
    <div class="wrapper no-flex">
      <div class="movie-title">
        <div class="img-title">
          ...
          <h2>SONIC (ORIGINAL VERSION) <br> <form action="tickets.php"><input type="submit" value="Tijden en Tickets"></form></h1>
        </div>
      </div>
      ...
      <div class="times">
        <h3>Today</h3>
        <div class="time">
          <a href="#"><p>18:10 - 20:04</p></a>
          <a href="#"><div class="special-seat"><span>Special Seat</span></div></a>
        </div>
        <h3>Tommorow</h3>
        <div class="time">
          <a href="#"><p>18:10 - 20:04</p></a>
