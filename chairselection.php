...
<?php
    $sql    = "SELECT * from stoelen"; // select column , * = all , from what table?, | -- string
                    ...
                    <tr>
                      <?php
                          ...
                          foreach ($stoelen as $stoel) {
                              ...
                              echo "<td class='seat'>";
                              echo "<input type='checkbox' name='seats[]' value='" . $stoel['stoel'] . "' id='" . $stoel['stoel'] . "'";
                              // IF CHECKED ADD CHECKED TO HTML
                              if ( $stoel['checked'] == "checked" ) {
                                  echo $stoel['checked'] . "/>";
                              }
                              // CLOSES THE INPUT IF ISNT CHECKED
                              else {
                                  echo "/>";
                              }
                              // SETS THE LABEL WITH THE CORRECT SEAT
                              echo "<label for=" . $stoel['stoel'] . ">" . $stoel['stoel'] . "</label>";
                              echo "</td>";
